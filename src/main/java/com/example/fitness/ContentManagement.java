...
public class ContentManagement {
	 private static final Logger logger = Logger.getLogger(ContentManagement.class.getName());
	    ...
	    private static void editArticleById() {
	        ...
	        // Logic to update the article content (e.g., updating the article in a file or database)
	    ...
	    private static void deleteArticleById() {
	        ...
	        Scanner scanner = new Scanner(System.in);
	        String id = scanner.nextLine();
	        // Logic to delete the article by ID (e.g., removing it from a file or database)
	        logger.log(Level.INFO, "\u001B[34mArticle ID {0} deleted!\u001B[0m", id);
	    }
}
